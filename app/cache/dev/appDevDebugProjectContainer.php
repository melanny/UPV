...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Symfony\Bridge\Doctrine\Mapping\Driver\YamlDriver(array(0 => '/var/www/FormularioUPV/src/Tipddy/UPVBundle/Resources/config/doctrine'));
        $d->setNamespacePrefixes(array('/var/www/FormularioUPV/src/Tipddy/UPVBundle/Resources/config/doctrine' => 'Tipddy\\UPVBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Tipddy\\UPVBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('TipddyUPVBundle' => 'Tipddy\\UPVBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/FormularioUPV/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'df16a8a9e0a798554cf2e3c31de4e925');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/FormularioUPV/vendor/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => 'df16a8a9e0a798554cf2e3c31de4e925',
            ...
            'kernel.secret' => 'df16a8a9e0a798554cf2e3c31de4e925',
